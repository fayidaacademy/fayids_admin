  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const processing = responseData.filter(item => item.status === 'processing').length;
        const failed = responseData.filter(item => item.status === 'failed').length;
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Pending Transactions</h1>
              <p className="text-gray-600">Review and process pending transaction requests</p>
            </div>
          </div>
