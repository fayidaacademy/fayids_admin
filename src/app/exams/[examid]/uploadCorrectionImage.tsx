...
export default function UploadCorrectionImage(params: any) {
  ...
  //   xhr.open(
  //     "POST",
  //     `${apiUrl}/questionimageupload/upload_correction_image/${QuestionId}`
  //   );
  //   xhr.send(formData);
  // };
  ...
  return (
    <div>
      ...
      <form
        method="POST"
        action={`${apiUrl}/questionimageupload/upload_correction_image/${QuestionId}`}
        id="myForm"
