...
export default function UploadVideo(params: any) {
  ...
  //   xhr.open(
  //     "POST",
  //     `${apiUrl}/courseintroductionvideo/upload_video/${CourseId}`
  //   );
  //   xhr.send(formData);
  // };
  ...
  return (
    <div>
      ...
      <form
        method="POST"
        action={`${apiUrl}/courseintroductionvideo/upload_video/${CourseId}`}
        id="myForm"
        encType="multipart/form-data"
        onSubmit={handleSubmit}
      >
        <label
          htmlFor="course_introduction_video"
        ...
        <input
          type="file"
          className="hidden"
          id="course_introduction_video"
          name="course_introduction_video"
        />
        <input type="submit" />
      </form>
    </div>
