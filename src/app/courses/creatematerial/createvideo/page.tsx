...
export default function CreateVideo() {
  return (
      ...
      <div className="absolute top-1/2 left-1/3 w-32 h-32 bg-pink-300/20 rounded-full blur-xl animate-pulse delay-500"></div>
      <div className="absolute top-1/4 right-1/4 w-24 h-24 bg-red-300/25 rounded-full blur-lg animate-pulse delay-700"></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Create Video Material</h1>
              <p className="text-gray-600 mt-1">Add a video to your course materials</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 mt-1">Fill in the video information</p>
                </div>
              </div>
            </div>
            <div className="p-8">
