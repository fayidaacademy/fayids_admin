...
export default function CreateMaterialLink() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-red-300/25 rounded-full blur-3xl animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-1/3 w-32 h-32 bg-orange-300/20 rounded-full blur-xl animate-pulse delay-500"></div>
      <div className="absolute top-1/4 right-1/4 w-24 h-24 bg-yellow-300/25 rounded-full blur-lg animate-pulse delay-700"></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Create Link Material</h1>
              <p className="text-gray-600 mt-1">Add a link to your course materials</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-orange-600 to-red-600 p-6">
              <div className="flex items-center space-x-3">
                <LinkIcon className="h-8 w-8 text-white" />
                <div>
                  <h2 className="text-xl font-semibold text-white">Link Details</h2>
                  <p className="text-orange-100 mt-1">Fill in the link information</p>
                </div>
              </div>
            </div>
            <div className="p-8">
