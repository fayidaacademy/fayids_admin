        ...
        <div className="mb-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900 mb-3">
                  Courses Management
                </h1>
                <p className="text-gray-600 text-xl leading-relaxed">
                  Effortlessly manage and organize your comprehensive course
                  catalog with advanced tools and insights.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-gray-900 mt-2">
                  {data.filter((course: any) => course.parts > 0).length}
                </p>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-gray-900 mt-2">
                  {data.reduce((sum: number, course: any) => {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-2 text-lg">
                  View and manage your course collection
                </p>
              </div>
