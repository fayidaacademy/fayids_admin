  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-40 h-40 bg-gradient-to-tr from-accent-400/20 to-primary-400/20 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="mb-8 animate-slide-up">
          <div className="flex items-center mb-4">
            <svg className="h-6 w-6 text-yellow-600 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4.5 19.5L21 3" />
            </svg>
            <div>
        ...
        {/* Notifications List */}
        {notificationData?.map && notificationData.length > 0 ? (
                          ...
                          <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-3">
                              <div className={`w-2 h-2 rounded-full ${
                                notification?.status == "0" ? "bg-primary-500" : "bg-gray-300"
                              }`}></div>
          ...
          <div className="bg-white rounded-xl p-12 shadow-sm border border-gray-100 text-center animate-slide-up" style={{animationDelay: '0.1s'}}>
            <svg className="h-16 w-16 text-gray-400 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4.5 19.5L21 3" />
            </svg>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Notifications</h3>
            <p className="text-gray-600 mb-6">You're all caught up! No new notifications at this time.</p>
            <div className="inline-flex items-center px-4 py-2 bg-primary-50 text-primary-700 rounded-lg">
              ...
              <span className="text-sm font-medium">All notifications up to date</span>
            </div>
          </div>
        )}
      </div>
