...
export default function UploadPackageThumbnail(params: any) {
  const PackageId = params.packageId;

  console.log("PackageIddd: " + PackageId);
  ...
  //   xhr.open(
  //     "POST",
  //     `${apiUrl}/mockexampackage/upload_package_thumbnail/${PackageId}`
  //   );
  //   xhr.send(formData);
  // };
  ...
  return (
    <div>
      ...
      <form
        method="POST"
        action={`${apiUrl}/mockexampackage/upload_package_thumbnail/${PackageId}`}
        id="myForm"
      ...
      >
        ...
        >
          <span className="text-blue-900 font-semibold">Update Thumbnail</span>
        </label>
        <input
          type="file"
          className="hidden"
