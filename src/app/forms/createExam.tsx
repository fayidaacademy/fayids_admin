...
export default function CreteExamForm() {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Exam Index</FormLabel>
                <FormControl>
                  <div className="w-1/2">
                    <Input
                ...
                <FormDescription>We use this to order the exam</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Exam Description (optional)</FormLabel>
                <FormControl>
                  <div className="w-1/2">
                    <Input
                      placeholder="type the Description here ..."
